...
export async function translateWithAccuracy(text: string, targetLang: string, signal?: AbortSignal): Promise<{ translatedText: string, accuracy: number, reason: string }> {
    try {

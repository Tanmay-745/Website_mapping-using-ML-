                ...
                {view === 'list' ? (
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="space-y-2">
                            ...
                            />
                            {formData.headerHtml.match(/https?:\/\/[^\s<]+/i) && (
                                <div className="mt-2 p-2 border rounded bg-gray-50 flex flex-col items-center">
                                    <p className="text-[10px] text-gray-400 mb-1 uppercase font-bold self-start">Live Header Preview</p>
                                    <img 
                                        src={formData.headerHtml.match(/https?:\/\/[^\s<]+/i)?.[0]} 
                                        alt="Header Preview" 
                                        className="max-h-24 object-contain shadow-sm bg-white"
                                    />
                                </div>
                            )}
                        </div>

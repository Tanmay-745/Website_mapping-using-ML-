      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredAdvocates.map((advocate) => (
          <Card key={advocate.id} className="p-6 bg-white dark:bg-gray-800 relative group overflow-hidden border-none shadow-sm ring-1 ring-gray-100 dark:ring-gray-700 hover:shadow-md transition-all">
            ...
            {advocate.headerHtml?.match(/https?:\/\/[^\s<]+/i) && (
              <div className="mb-4 -mx-6 -mt-6 border-b border-gray-100 dark:border-gray-700 h-16 bg-gray-50 flex items-center justify-center overflow-hidden">
                <img 
                  src={advocate.headerHtml.match(/https?:\/\/[^\s<]+/i)?.[0]} 
                  alt="Header" 

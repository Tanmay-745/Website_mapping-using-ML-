                    ...
                    <thead>
                        <tr className="bg-gray-50 dark:bg-gray-800/50">
                            {headers.map((header, index) => (
                                <th
                                    key={index}
                                    className="text-left px-2 py-2 font-semibold text-gray-700 dark:text-gray-300 border-b-2 border-gray-200 dark:border-gray-700 whitespace-nowrap max-w-[150px] truncate"
                                    title={header}
                                >
                                    {header}
                                </th>
